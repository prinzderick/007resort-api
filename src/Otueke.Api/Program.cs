...
using Otueke.Api.Endpoints;
using Otueke.SharedKernel.Time;
...
try
{
    ...
    builder.Services
        .AddOptions<OtuekeOptions>()
        .Bind(builder.Configuration.GetSection(OtuekeOptions.SectionName))
        .ValidateOnStart();
    ...
    builder.Services.AddOtuekeHealthChecks();
...
{
    Log.Fatal(ex, "Otueke API terminated unexpectedly");
    throw;
}
finally
{
