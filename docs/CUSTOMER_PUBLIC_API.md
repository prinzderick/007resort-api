...
| Website service token | `r7s_` | `service` | `service_token` | GET-only public reads (`public.read`); social sign-in endpoints with scope `customer.social` (docs/CUSTOMER_SOCIAL_LOGIN.md) |
