...
Route::middleware('auth:staff')->prefix('memberships')->group(function () {
    ...
    Route::post('/', [MembershipController::class, 'purchase'])->middleware(['permission:membership.sell', 'idempotent']);
    ...
    Route::middleware('permission:membership.view')->group(function () {
        Route::get('{membership}', [MembershipController::class, 'show'])->whereUuid('membership');
