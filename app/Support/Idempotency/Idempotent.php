...
class Idempotent
{
    ...
    public function handle(Request $request, Closure $next, ?string $scope = null): Response
    {
        ...
        $actor = RequestContext::staffId() ?? (RequestContext::customerId() ? 'c:'.RequestContext::customerId() : null) ?? (RequestContext::serviceTokenId() ? 's:'.RequestContext::serviceTokenId() : null) ?? RequestContext::deviceId() ?? 'anonymous';
